        ...
        <div className="mx-auto grid gap-5 md:grid-cols-2 md:gap-6 lg:gap-8">
          <Card className="group border-border/50 from-card to-card/80 hover:border-primary/50 relative flex flex-col overflow-hidden border-2 bg-linear-to-br p-5 transition-all duration-300 hover:shadow-lg md:p-6">
            ...
            <div className="relative mb-4 flex items-center gap-3 md:mb-8">
              ...
              <div>
                <h3 className="text-lg font-bold md:text-xl">{t("step1_simple_title")}</h3>
                <p className="text-muted-foreground text-xs md:text-sm">
                  {t("step1_simple_subtitle")}
                </p>
              </div>
            </div>
            ...
            <div className="relative mb-4 flex-1 space-y-2.5 md:mb-8 md:space-y-4">
              <div className="flex items-center gap-2.5">
                ...
                <p className="text-sm">{t("step1_simple_feature1")}</p>
              </div>
              <div className="flex items-center gap-2.5">
                <Icons.Check className="h-4 w-4 text-green-600 dark:text-green-400" />
                <p className="text-sm">{t("step1_simple_feature2")}</p>
              </div>
              <div className="flex items-center gap-2.5">
                <Icons.Check className="h-4 w-4 text-green-600 dark:text-green-400" />
                <p className="text-sm">{t("step1_simple_feature3")}</p>
              </div>
            </div>
          ...
          <Card className="group border-border/50 from-card to-card/80 hover:border-primary/50 relative flex flex-col overflow-hidden border-2 bg-linear-to-br p-5 transition-all duration-300 hover:shadow-lg md:p-6">
            ...
            <div className="relative mb-4 flex items-center gap-3 md:mb-8">
              ...
              <div>
                <h3 className="text-lg font-bold md:text-xl">{t("step1_complete_title")}</h3>
                <p className="text-muted-foreground text-xs md:text-sm">{t("step1_complete_subtitle")}</p>
              </div>
            </div>
            ...
            <div className="relative mb-4 flex-1 space-y-2.5 md:mb-8 md:space-y-4">
              <div className="flex items-center gap-2.5">
                ...
                <p className="text-sm">{t("step1_complete_feature1")}</p>
              </div>
              <div className="flex items-center gap-2.5">
                <Icons.Check className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                <p className="text-sm">{t("step1_complete_feature2")}</p>
              </div>
              <div className="flex items-center gap-2.5">
                <Icons.Check className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                <p className="text-sm">{t("step1_complete_feature3")}</p>
              </div>
            </div>
